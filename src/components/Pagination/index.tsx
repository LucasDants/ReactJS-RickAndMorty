...
export function Pagination({ totalCountOfRegisters, registersPerPage = 10, currentPage = 1, onPageChange }: PaginationProps) {
    ...
    return (
        ...
        >
            <Box>
                <strong>{registersPerPage * (currentPage - 1)}</strong> - <strong>{registersPerPage * currentPage > totalCountOfRegisters ? totalCountOfRegisters : registersPerPage * currentPage }</strong> of <strong>{totalCountOfRegisters}</strong>
            </Box>
            <Stack
                direction="row"
                spacing="2"
